...
address = ["0x240BaE5A27233Fd3aC5440B5a598467725F7D1cd", "0x38b6ab6B9294CCe1Ccb59c3e7D390690B4c18B1A"]
...
for ad in address:
    for i in range(end_block, start_block, -10000):
        url = "https://api.etherscan.io/api?module=account&action=tokentx&address=" + ad + \
              "&startblock=" + str(i - 10000) + "&endblock=" + str(
